...
class ECGConfig:
    ...
    def __str__(self):
        ...
        return ((
                ...
                "Default data path {4}\n" +
                "Default fr path: {5}\n" +
                "Default images path {6}\n" +
                "Default fr images path: {7}\n"
                ).format(self.config_block,  self.sig_name, self.file_name, self.multiplier, self.data_path, self.fr_path, self.img_path, self.fr_img_path))